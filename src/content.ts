        ...
        <figure class="wide-figure roofline-figure">
          ...
          <div class="roofline-lab">
            <div class="roofline-chart" data-roofline-chart>
              ...
              <span class="axis-y">relative ceiling · log scale</span><span class="axis-x">arithmetic intensity · log scale →</span>
            </div>
...
<span class="cm"># KV occupancy, preemption/recompute, and per-rank utilization.</span></code></pre>
      ...
      <section class="chapter sources-chapter" id="sources" data-chapter="Sources">
        ...
        <div class="source-ledger" data-source-ledger>
          ...
          <article data-search="gpu occupancy registers allocation shared memory residency"><span>Hardware methods · checked 2026-09-09</span><h3>CUDA occupancy and resource limits</h3><p>Register allocation, residency and the distinction between occupancy and achieved performance.</p><a href="https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/index.html#occupancy" target="_blank" rel="noreferrer">CUDA Best Practices</a></article>
          <article data-search="collectives allreduce reduce scatter gather nccl ring"><span>Communication · checked 2026-09-09</span><h3>Collective result contracts</h3><p>Rank ordering and output ownership for reduction and data-exchange operations.</p><a href="https://docs.nvidia.com/deeplearning/nccl/user-guide/docs/usage/collectives.html" target="_blank" rel="noreferrer">NCCL documentation</a></article>
          <article data-search="cuda streams events dma asynchronous graphs"><span>Execution · checked 2026-09-09</span><h3>Asynchronous device execution</h3><p>Streams, completion, memory-transfer dependencies and graph replay.</p><a href="https://docs.nvidia.com/cuda/cuda-programming-guide/02-basics/asynchronous-execution.html" target="_blank" rel="noreferrer">CUDA Programming Guide</a></article>
          <article data-search="adam optimizer moments bias correction"><span>Training methods · checked 2026-09-09</span><h3>Adam</h3><p>First- and second-moment estimates and the bias-corrected optimizer update.</p><a href="https://arxiv.org/abs/1412.6980" target="_blank" rel="noreferrer">Original paper</a></article>
          <article data-search="adamw decoupled weight decay l2 optimizer"><span>Training methods · checked 2026-09-09</span><h3>Decoupled weight decay</h3><p>The distinction between an L2 gradient contribution and a separate parameter shrinkage step.</p><a href="https://arxiv.org/abs/1711.05101" target="_blank" rel="noreferrer">AdamW paper</a></article>
          <article data-search="mixed precision fp16 bf16 master weights loss scaling"><span>Training numerics · checked 2026-09-09</span><h3>Mixed Precision Training</h3><p>Lower-precision compute, higher-precision update copies and loss scaling.</p><a href="https://arxiv.org/abs/1710.03740" target="_blank" rel="noreferrer">Original paper</a></article>
          <article data-search="keras loss scale optimizer nonfinite skipped update"><span>Runtime contract · checked 2026-09-09</span><h3>Keras loss-scale optimizer</h3><p>The current wrapper interface and its nonfinite-gradient behavior, tested separately on CPU.</p><a href="https://keras.io/api/optimizers/loss_scale_optimizer/" target="_blank" rel="noreferrer">Keras 3 API</a></article>
          <article data-search="activation checkpointing rematerialization recompute memory"><span>Training memory · checked 2026-09-09</span><h3>Activation recomputation</h3><p>Compute/storage tradeoffs and TensorFlow's checkpointed differentiation interface.</p><a href="https://arxiv.org/abs/1604.06174" target="_blank" rel="noreferrer">Memory schedules</a> <a href="https://www.tensorflow.org/api_docs/python/tf/recompute_grad" target="_blank" rel="noreferrer">TensorFlow API</a></article>
          ...
          <article data-search="blackwell tensor memory tmem accumulator tcgen05 cutlass shared registers"><span>Kernel architecture · checked 2026-09-08</span><h3>Blackwell tcgen05 and Tensor Memory</h3><p>Operand placement, accumulator storage, and the programming contract behind the SM teaching model.</p><a href="https://docs.nvidia.com/cutlass/4.5.2/media/docs/pythonDSL/mma_docs/tcgen05_programming.html" target="_blank" rel="noreferrer">NVIDIA CUTLASS 4.5.2</a></article>
          <article data-search="tensorflow distributed custom training global batch loss normalization gradients"><span>Training implementation · checked 2026-09-08</span><h3>Distributed loss scaling</h3><p>TensorFlow's custom-loop guidance for replica loss scaling and gradient aggregation.</p><a href="https://www.tensorflow.org/tutorials/distribute/custom_training" target="_blank" rel="noreferrer">TensorFlow</a></article>
          <article data-search="tensorflow mirroredstrategy cpu logical devices replica runtime configuration"><span>Training runtime · checked 2026-09-08</span><h3>Logical devices and mirrored replicas</h3><p>Device initialization and replica execution APIs used by the laptop-scale runtime equality check.</p><a href="https://www.tensorflow.org/api_docs/python/tf/config/set_logical_device_configuration" target="_blank" rel="noreferrer">Logical devices</a> <a href="https://www.tensorflow.org/api_docs/python/tf/distribute/MirroredStrategy" target="_blank" rel="noreferrer">MirroredStrategy</a></article>
          <article data-search="cuda tiled matrix multiplication shared memory barriers syncthreads simt kernel"><span>Kernel implementation · checked 2026-09-08</span><h3>CUDA SIMT kernel programming</h3><p>Thread/block ownership, shared-memory communication and synchronization behind the original tiled-matmul lesson.</p><a href="https://docs.nvidia.com/cuda/cuda-programming-guide/02-basics/writing-cuda-kernels.html" target="_blank" rel="noreferrer">NVIDIA</a></article>
          <article data-search="compute sanitizer memcheck racecheck synccheck cuda correctness shared memory race"><span>Kernel verification · checked 2026-09-08</span><h3>Compute Sanitizer</h3><p>Memory-access, shared-memory hazard and synchronization checks to run on a CUDA machine.</p><a href="https://docs.nvidia.com/compute-sanitizer/ComputeSanitizer/index.html" target="_blank" rel="noreferrer">NVIDIA</a></article>
          <article data-search="tensorflow profiler trace timeline host device performance"><span>Profiling · checked 2026-09-08</span><h3>TensorFlow Profiler</h3><p>Capture and inspect the input, host, and device activity behind a training step.</p><a href="https://www.tensorflow.org/guide/profiler" target="_blank" rel="noreferrer">TensorFlow</a></article>
          <article data-search="nsight systems compute profiler trace timeline kernel occupancy bandwidth"><span>Profiling · checked 2026-09-08</span><h3>System timeline and kernel profiling</h3><p>Use whole-system timelines to find exposed work, then inspect the responsible kernels and metric limitations.</p><a href="https://docs.nvidia.com/nsight-systems/UserGuide/index.html" target="_blank" rel="noreferrer">Nsight Systems</a> <a href="https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html" target="_blank" rel="noreferrer">Nsight Compute</a></article>
          <article data-search="vllm bench serve benchmark load ttft latency goodput"><span>Serving experiments · checked 2026-09-08</span><h3>vLLM serving benchmark</h3><p>Workload and measurement options for defining a reproducible serving experiment.</p><a href="https://docs.vllm.ai/en/latest/cli/bench/serve/" target="_blank" rel="noreferrer">vLLM</a></article>
          ...
          <article data-search="speculative sampling residual correction exact distribution"><span>Inference methods · checked 2026-09-09</span><h3>Speculative sampling</h3><p>Modified rejection sampling and conditional generation, with the hardware-numerics boundary made explicit.</p><a href="https://arxiv.org/abs/2302.01318" target="_blank" rel="noreferrer">Chen et al.</a></article>
          <article data-search="vllm speculative decoding eagle mtp draft ngram suffix lossless"><span>Inference implementation · checked 2026-09-09</span><h3>vLLM speculation methods</h3><p>Current proposal families, configuration boundaries and lossless-guarantee discussion.</p><a href="https://docs.vllm.ai/en/latest/features/speculative_decoding/" target="_blank" rel="noreferrer">vLLM documentation</a></article>
