...
${exercise("A request returns six tokens: the first at 100 ms and the last at 200 ms. What are TTFT and TPOT?", "TTFT is 100 ms. Five intervals remain after the first token, so TPOT is (200−100)/5 = 20 ms/token. Those intervals could be 20,20,20,20,20 ms or 5,5,5,5,80 ms. Equal averages can hide a noticeable stall; inspect the individual gaps too.")}
