...
export function prepareReader() {
  ...
  byId("network-embeddings")!.insertAdjacentHTML("afterend", positionLesson);
  byId("network-residual")!.insertAdjacentHTML("afterend", normalizationLesson);
  byId("network-output")!.insertAdjacentHTML("afterend", transformerBudgetLesson);
  byId("pretraining-experiments")!.insertAdjacentHTML("beforebegin", evaluationFoundationsLessons);
